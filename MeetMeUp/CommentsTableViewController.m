...
- (void)viewDidLoad
{
    ...
    NSURL *url = [NSURL URLWithString:[NSString stringWithFormat: @"https://api.meetup.com/2/event_comments?&sign=true&photo-host=public&event_id=%@&page=20&key=3803e4f78691614d7e70111a25e42", self.event.eventID]];
